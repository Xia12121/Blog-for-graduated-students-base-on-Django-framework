...
urlpatterns = [
    ...
    path(
        ...
        views.update_personal_statement,
        name='update_personal_statement',
    ),
    path('modify_password_here/', views.modify_password_here, name='modify_password_here'),
    path(
        'homegapg/<str:username>/',
        views.Personal_homepage_other,
        name='personal_homepage_other',
    ),
    path(
        'send-message/<str:recipient_username>/',
        views.send_message,
        name='send_message',
    ),
